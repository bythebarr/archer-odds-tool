...
export default async function MlbSlatePage({
  ...
  return (
    <div className="mx-auto min-h-screen max-w-3xl px-4 py-10 font-sans">
      <Link href={`/slate?date=${date}`} className="text-sm text-muted-foreground hover:text-foreground hover:underline">
        ← Slate
      </Link>
      <h1 className="mt-3 text-xl font-semibold text-foreground">MLB — full slate odds</h1>
